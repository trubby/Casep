...
public class CaseTask4 extends BukkitRunnable{
	...
	public CaseTask3 caseTask;
	
	public CaseTask4(CaseTask3 cs) {
		this.caseTask = cs;
		p = caseTask.p;
	...
	public void run() {
		if(count > 4){
			new CaseTask5(this).runTaskTimer(case_prac.instance, 0, 10);
			this.cancel();
		}else{
			doGlasses();
			doItems(itemRotate);
